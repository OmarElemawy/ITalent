...
public class CompetitionActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.home_container,new CompetitionFragment()).commit();
    ...
    private void setupBottomNavigationView() {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                {
                    case R.id.home_icon:
                        Intent intent=new Intent(CompetitionActivity.this, HomeActivity.class);
                        startActivity(intent);
                        break;
                    case R.id.competition_icon:
                        Intent intent1=new Intent(CompetitionActivity.this, CompetitionActivity.class);
                        startActivity(intent1);
                        break;
                    case R.id.add_icon:
                        Intent intent2=new Intent(CompetitionActivity.this, AddActivity.class);
                        startActivity(intent2);
                        break;
                    case R.id.profile_icon:
                        Intent intent3=new Intent(CompetitionActivity.this, ProfileActivity.class);
                        startActivity(intent3);
                        break;
                    case R.id.settings_icon:
                        Intent intent4=new Intent(CompetitionActivity.this, SettingActivity.class);
